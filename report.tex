...
\subsection{Auto-generated Table from Exported CSV}
When running the app and exporting, the CSV \texttt{images/candidate_speeds.csv} is produced. We include it below directly for traceability.

\begin{table}[H]
  \centering
  \caption{Candidate speeds — CSV exported from the application}
  \label{tab:csv-candidates}
  \csvautobooktabular{images/candidate_speeds.csv}
\end{table}

\subsection{Charts}
Figures show energy vs speed and time vs speed, highlighting the recommended point. (Rendered in-app using Matplotlib; exportable for report inclusion.)
...
Figures~\ref{fig:pm-energy} and \ref{fig:pm-time} were exported directly from the app using the “save charts” feature.

\begin{figure}[H]
  \centering
  \includegraphics[width=.85\textwidth]{images/paris_marseille_energy.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=.85\textwidth]{images/paris_marseille_time.png}
  \caption{Time vs Speed — Paris\,→\,Marseille}
  \label{fig:pm-time}
\end{figure}

\paragraph{Paris \textrightarrow{} Beauvais (shorter trip)}
Figures~\ref{fig:pb-energy} and \ref{fig:pb-time} illustrate a shorter route with different optimality tradeoffs.

\begin{figure}[H]
  \centering
  \includegraphics[width=.85\textwidth]{images/paris_beauvais_energy.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=.85\textwidth]{images/paris_beauvais_time.png}
...
Export: use the in-app export to save figures and CSV to \texttt{images/}.
